...
export default class Slider extends PureComponent {
  static propTypes = {
     ...
     */
    maximumTrackStyle: ViewPropTypes.style,
     ...
     */
    thumbElement: PropTypes.oneOfType([
      PropTypes.element,
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Animated.View
          renderToHardwareTextureAndroid
          style={[mainStyles.track, trackStyle, minTrackStyle, minimumTrackStyle]}
        />
        ...
        {interpolatedThumbValues.map((value, i) => (
          <Animated.View
            ...
            style={[
              ...
              mainStyles.thumb,
              Array.isArray(thumbStyle) ? thumbStyle[i] : thumbStyle,
              {
  ...
  _renderThumbElement = (thumbIndex = 0) => {
    const { thumbElement } = this.props;
